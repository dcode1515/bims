...
Vue.component('Residencycertificate', require('./components/Barangay/Residencycertificate.vue').default);
Vue.component('Inhabitants', require('./components/Barangay/Inhabitants.vue').default);
