                    ...
                    <div class="row g-3 align-items-center">
                        <div class="col-md-3">
                            <div class="input-group input-group">
                                ...
                                <select class="form-control form-control" v-model="perPage"
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group">
                                ...
                                <input type="text" class="form-control" v-model="searchQuery"
                                    @input="getDataBarangayInfo" placeholder="Search head of office..." />
                            </div>
                        </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="ps-4" width="50">
                                        <i class="ri-numbers-line"></i> <!-- For # -->
                                    </th>

                                    <th>
                                        <i class="ri-map-pin-line me-1"></i> <!-- Region -->
                                        Region
                                    </th>
                                    <th>
                                        <i class="ri-building-line me-1"></i> <!-- Province -->
                                        Province
                                    </th>
                                    <th>
                                        <i class="ri-government-line me-1"></i> <!-- Municipality -->
                                        Municipality
                                    </th>
                                    <th>
                                        <i class="ri-community-line me-1"></i> <!-- Barangay -->
                                        Barangay
                                    </th>
                                    <th>
                                        <i class="ri-home-2-line me-1"></i> <!-- Barangay Name -->
                                        Barangay Name
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr v-for="(barangayinfo, index) in barangay_info.data" :key="barangayinfo.id">
                                    <td class="ps-4">
                                        {{
                                            (barangay_info.current_page - 1) * barangay_info.per_page + index + 1
                                        }}
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-sm btn-outline-primary"
                                                @click="openModal('edit', barangayinfo)" title="Edit">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <span class="text-muted small">
                                        ...
                                        Showing {{ barangay_info.from }} to {{ barangay_info.to }} of
                                        {{ barangay_info.total }} entries
                                    </span>
                                </div>
                                <div class="col-md-6">
                                    <nav class="float-end">
                                        <ul class="pagination pagination-sm mb-0">
                                            <li class="page-item" :class="{ disabled: barangay_info.current_page === 1 }">
                                                <button class="page-link" @click="changePage(1)" title="First">
                                                    <i class="ri-skip-back-line"></i>
                                                </button>
                                            </li>
                                            <li class="page-item" :class="{ disabled: barangay_info.current_page === 1 }">
                                                <button class="page-link" @click="changePage(barangay_info.current_page - 1)"
                                                    title="Previous">
                                            ...
                                            <li class="page-item" :class="{
                                                disabled: barangay_info.current_page === barangay_info.last_page,
                                            }">
                                                <button class="page-link" @click="changePage(barangay_info.current_page + 1)"
                                                    title="Next">
                                            ...
                                            <li class="page-item" :class="{
                                                ...
                                                <button class="page-link" @click="changePage(barangay_info.last_page)"
                                                    title="Last">
                        ...
                        <!-- Modal Section -->
                        <div class="modal fade zoomIn" id="modalBrgyInfo" tabindex="-1"
                                    ...
                                    <div class="modal-body p-4">
                                        <form>
                                            <div class="row g-3">
                                                ...
                                                <!-- Province -->
                                                <div class="col-md-12">
                                                    <label class="form-label">Regionss</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text bg-light">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-select" v-model="formData.municipality"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-select" v-model="formData.barangay">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            v-model="formData.zip_code" placeholder="Enter ZIP Code">
                                                    </div>
                                                </div>
    ...
    methods: {
        ...
        fetchProvinces() {
            ...
            if (this.formData.region) {
                axios.get(`/bims/get-provinces/${this.formData.region}`)
        ...
        fetchMunicipalities() {
            ...
            if (this.formData.province) {
                axios.get(`/bims/get-municipalities/${this.formData.province}`)
                    .then(res => this.municipalities = res.data);
            }
        },
        fetchBarangays() {
            this.barangays = [];
            ...
            if (this.formData.municipality) {
                axios.get(`/bims/get-barangays/${this.formData.municipality}`)
                    .then(res => this.barangays = res.data);
            }
        },
        openModal(mode, barangayinfo = null) {
            ...
            if (mode === "add") {
                ...
                this.formData = {
                    ...
                    province: barangayinfo.region,
                    municipality: barangayinfo.municipality,
                    barangay: barangayinfo.barangay,
                    barangay_code: barangayinfo.barangay_code,
                    zip_code: barangayinfo.zip_code,
