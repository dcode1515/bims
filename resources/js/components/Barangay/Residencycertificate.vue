      ...
      <div class="card border-0 shadow-sm">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
              <h5 class="mb-0 fw-semibold text-primary">
                Manage Residency Certificate
              </h5>
              <small class="text-muted"
                >Manage and monitor Building Permit records</small
              >
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
              ...
              <thead class="table-primary bg-opacity-10">
                <tr>
                  ...
                  <th><i class="ri-user-3-line me-1"></i> Name of Requester</th>
                   <th><i class="ri-user-3-line me-1"></i> Resident Type</th>
              ...
              <tbody>
                ...
                >
                  <td class="ps-4 fw-medium">
                    {{
                      (residents.current_page - 1) * residents.per_page +
                      index +
                      1
                    }}
                  </td>
                  <td>{{ resident.application_no }}</td>

                  <td>
                    {{ resident.requestor.first_name }}
                    {{ resident.requestor.middle_initial }}.
                    {{ resident.requestor.last_name }}
                  </td>
                   <td>{{ resident.resident_type }}</td>
                  <td>{{ resident.purpose }}</td>

                  <td>{{ resident.purok.purok_name }}</td>
                  <td>{{ formatDate(resident.date_issued) }}</td>
            ...
            <div v-if="residents.total > 0" class="card-footer bg-white">
              <div class="row align-items-center">
                <div class="col-md-6">
                  <span class="text-muted small">
                    <i class="ri-file-list-line me-1"></i>
                    Showing {{ residents.from }} to {{ residents.to }} of
                    {{ residents.total }} entries
                  </span>
                </div>
                <div class="col-md-6">
                  <nav class="float-end">
                    <ul class="pagination pagination-sm mb-0">
                      <li
                        class="page-item"
                        :class="{ disabled: residents.current_page === 1 }"
                      >
                        <button
                          class="page-link"
                          @click="changePage(1)"
                      ...
                      >
                        <button
                          class="page-link"
                          @click="changePage(residents.current_page - 1)"
                          title="Previous"
                        >
                      ...
                      <li
                        ...
                        :key="page"
                        class="page-item"
                        :class="{ active: page === residents.current_page }"
                      >
                      ...
                      >
                        <button
                          class="page-link"
                          @click="changePage(residents.last_page)"
                          title="Last"
                        >
                  ...
                  <div class="modal-body p-4">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-12">
                          <label class="form-label fw-medium">
                            <i class="ri-home-4-line me-1 text-muted"></i
                            >Resident Type
                          ...
                          <div class="input-group">
                            ...
                            <select
                              v-model="formData.resident_type"
                              class="form-select"
                            >
                              <option value="" disabled selected>
                                Select an Resident Type
                              </option>
                              <option value="Permanent Resident">
                                Permanent Resident
                              </option>
                              <option value="Bonafide Resident">
                                Bonafide Resident
                              </option>
                              <option value="Registered Resident">
                                Registered Resident
                              </option>
                              <option value="Temporary Resident">
                                Temporary Resident
                              </option>
                              <option value="Transient Resident">
                                Transient Resident
                              </option>
                              <option value="Current Resident">
                                Current Resident
                              </option>
                              <option value="Former Resident">
                                Former Resident
                              </option>
                              <option value="Long-Time Resident">
                                Long-Time Resident
                              </option>
                              <option value="Legal Resident">
                                Legal Resident
                              </option>
                              <option value="Home Owner Resident">
                                Home Owner Resident
                              </option>
                            </select>
                          </div>
                        ...
                        <div class="col-md-6">
                          <label class="form-label fw-medium">
                            <i class="ri-map-pin-line me-1 text-muted"></i>Date
                            Issued
                          </label>
                          <div class="input-group">
                            <span
                      ...
                      <div class="d-flex">
                        ...
                        <div>
                          ...
                          <ul class="text-muted small mb-0 mt-1 ps-3">
                            <li>
                              This building permit is valid for 1 year from date
                              issued
                            </li>
...
export default {
  ...
  methods: {
    ...
    changePage(page) {
      if (page >= 1 && page <= this.residents.last_page) {
        this.residents.current_page = page;
        this.getDataResident();
      }
    },
    ...
    openModal(mode, indigency) {
      ...
      if (mode === "add") {
        this.modalTitle = "Add Residency Certificate";
        this.formData = {
          name_requestor: "",
          purok: "",
          purpose: "",
        ...
        this.modalTitle = "Edit Residency Certificate";
        this.formData = {
          ...indigency,
  ...
  data() {
    return {
      ...
      loading: false,
      modalMode: "add",
      modalTitle: "Add Residency Certificate",
      formData: {
        name_requestor: null,
        resident_type:"",
        purok: "",
  ...
  computed: {
    ...
    pages() {
      const pages = [];
      const total = this.residents.last_page;
      const current = this.residents.current_page;
      const maxVisible = 5;
