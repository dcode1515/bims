          ...
          <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
              ...
              <small class="text-muted"
                >Manage and monitor Death Certificate records</small
              >
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <tbody>
                <tr
                  v-for="(deathcert, index) in deathcerts.data"
                  :key="deathcert.id"
                >
                  <td class="ps-4 fw-medium">
                    {{
                      (deathcerts.current_page - 1) * deathcerts.per_page +
                      index +
                      1
                    }}
                  </td>
                  <td>{{ deathcert.application_no }}</td>

                  <td>
                    {{ deathcert.requestor.first_name }}
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      <button
                        ...
                        title="Edit"
                        @click="openModal('edit', deathcert)"
                      >
                ...
                <tr v-if="deathcerts.data.length === 0">
            ...
            <div v-if="deathcerts.total > 0" class="card-footer bg-white">
              <div class="row align-items-center">
                <div class="col-md-6">
                  <span class="text-muted small">
                    <i class="ri-file-list-line me-1"></i>
                    Showing {{ deathcerts.from }} to {{ deathcerts.to }} of
                    {{ deathcerts.total }} entries
                  </span>
                </div>
                <div class="col-md-6">
                  <nav class="float-end">
                    <ul class="pagination pagination-sm mb-0">
                      <li
                        class="page-item"
                        :class="{ disabled: deathcerts.current_page === 1 }"
                      >
                        <button
                          class="page-link"
                          @click="changePage(1)"
                      ...
                      >
                        <button
                          class="page-link"
                          @click="changePage(deathcerts.current_page - 1)"
                          title="Previous"
                        >
                      ...
                      <li
                        ...
                        :key="page"
                        class="page-item"
                        :class="{ active: page === deathcerts.current_page }"
                      >
                      ...
                      <li
                        ...
                        :class="{
                          disabled:
                            deathcerts.current_page === deathcerts.last_page,
                        }"
                      >
                        <button
                          class="page-link"
                      ...
                      >
                        <button
                          class="page-link"
                          @click="changePage(deathcerts.last_page)"
                          title="Last"
                        >
                  ...
                  <div class="modal-body p-4">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          <label class="form-label fw-medium">
                            <i class="ri-map-pin-line me-1 text-muted"></i>Place
                            of Death
                          </label>
                          <div class="input-group">
                            <span
...
export default {
  ...
  methods: {
    ...
    async getDataDeathCert() {
      try {
        ...
        this.deathcerts = response.data.data;
      } catch (error) {
    ...
    changePage(page) {
      if (page >= 1 && page <= this.deathcerts.last_page) {
        this.deathcerts.current_page = page;
        this.getDataDeathCert();
      }
    },
    ...
    openModal(mode, indigency) {
      ...
      if (mode === "add") {
        ...
        this.modalTitle = "Edit Death Certificate";
        this.formData = {
          ...indigency,
  ...
  computed: {
    ...
    pages() {
      const pages = [];
      const total = this.deathcerts.last_page;
      const current = this.deathcerts.current_page;
      const maxVisible = 5;
